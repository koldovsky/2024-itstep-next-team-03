...
export default function ShoppingCartSidebar({
  ...
  return (
    <div
      className={`${params.className} absolute z-50 top-0 h-[100vh] w-96 
              bg-white transition-all duration-500 p-5`}
    >
      <p className="text-2xl mb-4">Shopping cart</p>
      <hr />
      <div
        className="flex gap-6 flex-col h-[calc(100vh-400px)] overflow-y-scroll 
                orders-scrollbar orders-scrollbar-checkout"
      >
      ...
      <div
        className="absolute bottom-5 w-[calc(100%-40px)] 
                    flex flex-col justify-end gap-4 bg-white pt-5"
      >
