...
const Blog = ({ params }: { params: { blogId: string } }) => {
    const { blogId } = params;
    const blog: BlogItem | undefined = blogs.find(
        (b) => b.id === +blogId
    );
           ...
           <section className="p-3 sm:p-10 max-w-[1200px] mx-auto min-h-screen">
               <article className="min-h-screen">
                   ...
                   <div className="flex flex-col lg:flex-row w-full gap-8">
                       ...
                       <div className="w-full lg:w-1/2 lg:py-8">
                           <div className="mb-8">
                               ...
                               <p className="mb-4">
                                   Welcome to our jewelry boutique, where every piece tells a story
                                   of elegance and craftsmanship. From dazzling diamond rings to timeless
                                   gold necklaces, our collection is designed to celebrate life’s most
                                   precious moments. Whether you are searching for a unique engagement
                                   ring or a gift to mark a special occasion, we offer exquisite
                                   designs to suit every taste.
                               </p>
                               <p className="mb-4">
                                   Each piece is crafted with care, blending tradition with modern trends,
                                   ensuring you shine on every occasion. Let our jewelry become a reflection
                                   of your personality and style. Visit us today and discover the perfect
                                   sparkle for you or your loved ones!
                               </p>
                           </div>
                           {/* Product Cards Grid */}
                   ...
                   <div className="mt-16 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
                       {/*Content*/}
                       <h2 className="text-xl font-bold mb-2">Timeless Sparkle for Every Moment</h2>
                       <p className="mb-4">
                           ...
                           accessory—it’s a way to express emotions, capture memories,
                           and create personal connections.
                       </p>
                       <p className="mb-4">
                           Each gemstone and metal is carefully selected to ensure brilliance and durability.
                           Explore our boutique today and find the piece that speaks to your heart.
                       </p>
                       {/* Product Cards Grid */}
