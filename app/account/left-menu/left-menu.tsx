  ...
  const menuItems = [
    {
      name: "Profile",
      href: "/account",
      hrefToHighlight: "/account/editprofile",
      icon: <IoPersonCircleOutline size={23} />,
    },
    {
      name: "Wishlist",
      href: "/account/wishlist",
      icon: <SlHeart size={22} />,
    },
    {
      name: "Orders",
      href: "/account/orders",
  ...
  return (
    <div className=" lg:w-80 w-full bg-white lg:mr-5">
      <Link href="/account">
        <div className="flex items-center mb-4 border-b pb-4 ">
          ...
          <div className="flex flex-col">
            <div className="text-lg pb-0 mb-0">My Account</div>
      ...
      <ul>
        {menuItems.map((item) => {
          const isActive =
            pathname === item.href || pathname === item.hrefToHighlight;
          return (
