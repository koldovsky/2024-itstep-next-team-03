    ...
    <div className="max-w-3xl ">
      <PageHeading
        params={{
          ...
          className: "capitalize mb-4 text-3xl mt-0 pt-0",
        }}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <Input
              ...
              type="text"
              className="w-full"
              defaultValue="Mykhailo Nyskohuz"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input id="phone1" type="text" className="pl-10 pr-8" />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <ChevronDown className="absolute inset-y-0 right-0 flex items-center pr-3 h-full" />
              <Input id="phone2" type="text" className="pl-10 pr-8" />
            </div>
          </div>
          <div>
